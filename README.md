...
- Beautiful hero banner with soft animations
...
- **Palette**: Soft Sand — Sage (#8FA28A), Sage Light (#C7D3C0), Cream (#F7F4ED), Amber (#C8A96B)
- **Components**: daisyUI + custom utility classes
- **~60% Bangla content** throughout the UI

## Developer
Mahir Siam  
Email: mahirsiam2004@gmail.com  
GitHub: https://github.com/mahirsiam2004

## License
Copyright © 2025 Mahir Siam. All rights reserved.
This project is developed as part of a web development assignment (SDP Coursework).